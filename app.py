...
st.set_page_config(page_title="Polaris bank", layout="centered")
st.image("https://cdn-icons-png.flaticon.com/512/1052/1052854.png", width=100)
st.title("POLARIS BANK")
